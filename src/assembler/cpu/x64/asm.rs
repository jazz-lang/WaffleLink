use crate::assembler::cpu::{FReg, Reg};
use crate::assembler::masm::*;
...
mod tests {
    use super::super::*;
    use super::*;
    use crate::assembler::masm::{CondCode, MacroAssembler};
    ...
    macro_rules! assert_emit {
        (
            ...
            assert_eq!(expected, buf.data(&mut rt));
        }};
    ...
    fn test_emit_jcc_zero() {
        ...
        buf.nop();
        buf.bind_label(lbl);
        assert_eq!(vec![0x0f, 0x84, 1, 0, 0, 0, 0x90], buf.data(&mut rt));
    }
    ...
    fn test_emit_jcc_non_zero() {
        ...
        buf.nop();
        buf.bind_label(lbl);
        assert_eq!(vec![0x0f, 0x85, 1, 0, 0, 0, 0x90], buf.data(&mut rt));
    }
    ...
    fn test_emit_jcc_greater() {
        ...
        buf.nop();
        buf.bind_label(lbl);
        assert_eq!(vec![0x0f, 0x8F, 1, 0, 0, 0, 0x90], buf.data(&mut rt));
    }
    ...
    fn test_emit_jcc_greater_or_equal() {
        ...
        buf.nop();
        buf.bind_label(lbl);
        assert_eq!(vec![0x0f, 0x8D, 1, 0, 0, 0, 0x90], buf.data(&mut rt));
    }
    ...
    fn test_emit_jcc_less() {
        ...
        buf.nop();
        buf.bind_label(lbl);
        assert_eq!(vec![0x0f, 0x8C, 1, 0, 0, 0, 0x90], buf.data(&mut rt));
    }
    ...
    fn test_emit_jcc_less_or_equal() {
        ...
        buf.nop();
        buf.bind_label(lbl);
        assert_eq!(vec![0x0f, 0x8E, 1, 0, 0, 0, 0x90], buf.data(&mut rt));
    }
    ...
    fn test_emit_jcc_unsigned_greater() {
        ...
        buf.nop();
        buf.bind_label(lbl);
        assert_eq!(vec![0x0f, 0x87, 1, 0, 0, 0, 0x90], buf.data(&mut rt));
    }
    ...
    fn test_emit_jcc_unsigned_greater_or_equal() {
        ...
        buf.nop();
        buf.bind_label(lbl);
        assert_eq!(vec![0x0f, 0x83, 1, 0, 0, 0, 0x90], buf.data(&mut rt));
    }
    ...
    fn test_emit_jcc_unsigned_less() {
        ...
        buf.nop();
        buf.bind_label(lbl);
        assert_eq!(vec![0x0f, 0x82, 1, 0, 0, 0, 0x90], buf.data(&mut rt));
    }
    ...
    fn test_emit_jcc_unsigned_less_or_equal() {
        ...
        buf.nop();
        buf.bind_label(lbl);
        assert_eq!(vec![0x0f, 0x86, 1, 0, 0, 0, 0x90], buf.data(&mut rt));
    }
    ...
    fn test_emit_jmp() {
        ...
        buf.nop();
        buf.bind_label(lbl);
        assert_eq!(vec![0xe9, 1, 0, 0, 0, 0x90], buf.data(&mut rt));
    }
