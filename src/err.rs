...
pub enum Msg {
    ...
    MethodExists(String, String, Location),
    ...
    pub fn message(&self) -> String {
        match self {
            ...
            ExpectedTopLevelElement(ref token) => {
                if token == "fun" {
                    return format!("expected function declaration,maybe you mean `func`?");
                }
                format!(
...
impl MsgWithPos {
    pub fn new(path: String, src: String, pos: Location, msg: Msg) -> MsgWithPos {
        MsgWithPos {
            path,
            pos,
            msg,
    ...
    pub fn without_path(pos: Location, msg: Msg) -> MsgWithPos {
        MsgWithPos {
            path: "".to_string(),
            src: String::new(),
            pos,
