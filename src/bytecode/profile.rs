...
impl ArithProfile {
    ...
    pub fn observe_result(&mut self, val: Value) {
        if val.is_int32() {
            return;
        }
        if val.is_number() {
...
impl ArithProfile {
    ...
    pub fn observe_unary_arg(&mut self, arg: Value) {
...
impl ArithProfile {
    ...
    pub fn observe_lhs(&mut self, val: Value) {
        let mut new_profile = *self;
        if val.is_number() {
            if val.is_int32() {
    ...
    pub fn observe_rhs(&mut self, val: Value) {
        let mut new_profile = *self;
        if val.is_number() {
            if val.is_int32() {
    ...
    pub fn observe_lhs_and_rhs(&mut self, lhs: Value, rhs: Value) {
