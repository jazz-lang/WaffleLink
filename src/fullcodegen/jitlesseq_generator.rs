...
impl FullGenerator for LessEqGenerator {
    fn fast_path(&mut self, gen: &mut FullCodegen) -> bool {
        ...
        gen.masm.set(REG_RESULT, CondCode::LessEq);
    ...
    fn slow_path(&mut self, gen: &mut FullCodegen) {
        ...
        gen.masm.raw_call(Runtime::compare_less_equal as *const u8);
        gen.masm.new_boolean(REG_RESULT,REG_RESULT);
